"""
Django settings for moj_notatnik project.
...
SECRET_KEY = 'django-insecure-w@b5&n$g^9+wpv&2)*^of!-sy*f&!&ogl&)&cdrilhg=bk5)h!'
...
WSGI_APPLICATION = 'moj_notatnik.wsgi.application'
